...
import { LibNote } from "./lib/lib.sol";
...
contract DssCdpManager is LibNote {
    ...
    // Frob the cdp keeping the generated BLC or collateral freed in the cdp urn address.
    function frob(
        uint cdp,
        int dink,
        int dart
    ...
    // Transfer wad amount of BLC from the cdp address to a dst address.
    function move(
        uint cdp,
        address dst,
        uint rad
